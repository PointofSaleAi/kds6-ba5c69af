...
const embeddedLabels: Record<LanguageCode, Record<string, string>> = {
  ...
  es: { 'TABLE': 'MESA', 'BAR': 'BARRA', 'PICKUP': 'RECOGER', 'DELIVERY': 'ENTREGA', 'BANQUET': 'BANQUETE', 'BANQUET A': 'BANQUETE A', 'BANQUET B': 'BANQUETE B', 'A': 'A', 'B': 'B', 'ago': 'atrás', 'Queued': 'En cola', 'Auto-fires': 'Auto', 'in': 'en', 'min': 'min', 'Pickup': 'Recoger', 'Server': 'Mesero', 'Host': 'Anfitrión', 'Manager': 'Gerente', 'POS': 'Point of Sale', 'POS terminal': 'Terminal Punto de Venta', 'POS terminal 1': 'Terminal Punto de Venta 1', 'POS terminal 2': 'Terminal Punto de Venta 2', 'POS terminal 3': 'Terminal Punto de Venta 3', 'Back office': 'Oficina', 'Order': 'Pedido', 'Just now': 'Ahora', 'RECALLED': 'RECUPERADO', 'RUSH': 'URGENTE', 'items': 'artículos', 'item': 'artículo', 'tickets': 'tickets', 'ticket': 'ticket', 'ORDER NOTES': 'NOTAS DEL PEDIDO', 'Read': 'Leído', 'Acknowledged': 'Confirmado', 'Acknowledge': 'Confirmar', 'Reply': 'Responder', 'Kitchen': 'Cocina', 'Notifications': 'Notificaciones', 'Kitchen messages': 'Mensajes de cocina', 'Clear read': 'Borrar leídas', 'No kitchen messages': 'Sin mensajes de cocina', 'All clear, no notifications': 'Todo en orden, sin notificaciones', 'Unseen orders': 'Pedidos no vistos' },
  zh: { 'TABLE': '桌号', 'BAR': '吧台', 'PICKUP': '自取', 'DELIVERY': '外卖', 'BANQUET': '宴会', 'BANQUET A': '宴会 A', 'BANQUET B': '宴会 B', 'A': 'A', 'B': 'B', 'ago': '前', 'Queued': '排队中', 'Auto-fires': '自动开始', 'in': '在', 'min': '分', 'Pickup': '自取', 'Server': '服务员', 'Host': '迎宾', 'Manager': '经理', 'POS': 'Point of Sale', 'POS terminal': '销售点终端', 'POS terminal 1': '销售点终端 1', 'POS terminal 2': '销售点终端 2', 'POS terminal 3': '销售点终端 3', 'Back office': '后台', 'Order': '订单', 'Just now': '刚刚', 'RECALLED': '召回', 'RUSH': '加急', 'items': '项', 'item': '项', 'tickets': '单', 'ticket': '单', 'ORDER NOTES': '订单备注', 'Read': '已读', 'Acknowledged': '已确认', 'Acknowledge': '确认', 'Reply': '回复', 'Kitchen': '厨房', 'Notifications': '通知', 'Kitchen messages': '厨房消息', 'Clear read': '清除已读', 'No kitchen messages': '无厨房消息', 'All clear, no notifications': '一切清晰,无通知', 'Unseen orders': '未查看订单' },
  vi: { 'TABLE': 'BÀN', 'BAR': 'QUẦY', 'PICKUP': 'TỰ LẤY', 'DELIVERY': 'GIAO HÀNG', 'BANQUET': 'TIỆC', 'BANQUET A': 'TIỆC A', 'BANQUET B': 'TIỆC B', 'A': 'A', 'B': 'B', 'ago': 'trước', 'Queued': 'Đang chờ', 'Auto-fires': 'Tự động', 'in': 'trong', 'min': 'phút', 'Pickup': 'Lấy', 'Server': 'Phục vụ', 'Host': 'Lễ tân', 'Manager': 'Quản lý', 'POS': 'Point of Sale', 'POS terminal': 'Máy Điểm bán hàng', 'POS terminal 1': 'Máy Điểm bán hàng 1', 'POS terminal 2': 'Máy Điểm bán hàng 2', 'POS terminal 3': 'Máy Điểm bán hàng 3', 'Back office': 'Văn phòng', 'Order': 'Đơn', 'Just now': 'Vừa xong', 'RECALLED': 'GỌI LẠI', 'RUSH': 'GẤP', 'items': 'món', 'item': 'món', 'tickets': 'đơn', 'ticket': 'đơn', 'ORDER NOTES': 'GHI CHÚ ĐƠN', 'Read': 'Đã đọc', 'Acknowledged': 'Đã xác nhận', 'Acknowledge': 'Xác nhận', 'Reply': 'Trả lời', 'Kitchen': 'Bếp', 'Notifications': 'Thông báo', 'Kitchen messages': 'Tin nhắn bếp', 'Clear read': 'Xóa đã đọc', 'No kitchen messages': 'Không có tin nhắn', 'All clear, no notifications': 'Không có thông báo', 'Unseen orders': 'Đơn chưa xem' },
};
