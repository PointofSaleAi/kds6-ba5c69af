...
const translations: Record<LanguageCode, Translations> = {
  'en-US': {
    ...
    twoLanguagesPerItem: 'Two languages per item',
    viewAs: 'View as',
    ...
    showingDualLang: 'Showing {primary} (primary) + {secondary} (secondary) on each item.',
    ...
    searchHistoryPlaceholder: 'Search by order number, table, server, or item...',
    recall: 'RECALL',
    itemsLabel: 'items',
    minLabel: 'min',
