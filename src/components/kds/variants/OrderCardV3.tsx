  ...
  return (
    <div className="bg-card rounded-md overflow-hidden border border-border shadow-sm flex flex-col">
      ...
      <div
        ...
        className={`relative flex items-center justify-center gap-1.5 px-2 py-1 text-[13px] font-bold uppercase tracking-wide ${isCompact ? 'cursor-pointer select-none' : ''} ${isCompact && bumping ? 'opacity-70 pointer-events-none' : ''}`}
