    ...
    >
      ...
      {canExpand && !done && (
        <button
          ...
          style={{ width: 18, height: 18, color: 'var(--tkt-icon-idle)' }}
      ...
      {loading && (
        <span className="shrink-0 mt-0.5 flex items-center justify-center" style={{ width: 16, height: 16 }} aria-label="Marking Product Done">
          <Loader2 size={12} className="animate-spin" color="var(--tkt-icon-idle)" />
        </span>
      )}
      {done && (
        <span
          ...
          <div className="grid grid-cols-2 bg-card border-b border-border">
            <div className="flex items-start gap-1.5 px-2 py-1.5">
              <div className="min-w-0">
                ...
                {identifierSub && <div className="text-[10px] text-[var(--tkt-text-secondary)] truncate">{identifierSub}</div>}
                {cell1Sub && cell1Sub !== identifierSub && cell1Sub !== identifierPrimary && (
                  <div className="text-[10px] text-[var(--tkt-text-muted)] truncate">{cell1Sub}</div>
                )}
              </div>
            </div>
            <div className="flex items-start gap-0.5 px-2 py-1.5 border-l border-border">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[10px] text-[var(--tkt-text-secondary)] truncate">{formatTime(order.timeReceived)}</div>
              </div>
            </div>
          </div>
        );
