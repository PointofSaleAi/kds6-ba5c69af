...
export const GLASS_ICON_PATHS = {
  ...
  phone: <><path d="M4.5 4h3l1.6 4-2 1.4a11.5 11.5 0 0 0 5.5 5.5l1.4-2 4 1.6v3a1.5 1.5 0 0 1-1.6 1.5A15.5 15.5 0 0 1 3 5.6 1.5 1.5 0 0 1 4.5 4Z" /></>,
  sched: <><rect x="3" y="5" width="18" height="16" rx="3" /><path d="M8 3v4" /><path d="M16 3v4" /><path d="M3 11h18" /></>,
  takeout: <><path d="M5 8h14l-1.4 12H6.4L5 8Z" /><path d="M8 8V6h8v2" /><path d="M10 12v4" /><path d="M14 12v4" /></>,
