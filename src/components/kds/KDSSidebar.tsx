...
export function KDSSidebar({ activeFilter, onFilterChange, onNavigate, activeNav = 'home', settingsOpen, seenCount = 0, unseenCount = 0, historyCount = 0 }: KDSSidebarProps) {
  ...
  return (
      <TooltipProvider delayDuration={300}>
        <div className={`${expanded ? 'w-48' : 'w-20'} py-2 ${settingsOpen ? 'pl-2 pr-0' : 'px-2'} bg-transparent flex flex-col h-full shrink-0 z-20 transition-all duration-300 ease-out`}>
        <div
